...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ual-ledger'), require('ual-plainjs-renderer'), require('universal-authenticator-library')) :
  typeof define === 'function' && define.amd ? define(['exports', 'ual-ledger', 'ual-plainjs-renderer', 'universal-authenticator-library'], factory) :
  (global = global || self, factory(global.VueUal = {}, global.ualLedger, global.ualPlainjsRenderer, global.universalAuthenticatorLibrary));
}(this, function (exports, ualLedger, ualPlainjsRenderer, universalAuthenticatorLibrary) { 'use strict';
  ...
  function (_User) {
    ...
    _createClass(MockUser, [{
      ...
      value: function signArbitrary(publicKey, data, helpText) {
        return new Promise(function (resolve, reject) {
          reject(new universalAuthenticatorLibrary.UALError('Not implemented', universalAuthenticatorLibrary.UALErrorType.Signing, null, 'Mock User'));
        });
      }
    }, {
    ...
    return MockUser;
  }(universalAuthenticatorLibrary.User);

  function MockAuthenticator(chains) {
    new universalAuthenticatorLibrary.Authenticator(chains);
    this.loading = true;
  }

  MockAuthenticator.prototype = Object.create(universalAuthenticatorLibrary.Authenticator.prototype);
  MockAuthenticator.prototype.constructor = MockAuthenticator;

  MockAuthenticator.prototype.toString = function () {
    return 'MockAuthenticator > ' + universalAuthenticatorLibrary.Authenticator.prototype.toString.call(this);
  };
  ...
  MockAuthenticator.prototype.getError = function () {
    return new universalAuthenticatorLibrary.UALError('Initialization Error', universalAuthenticatorLibrary.UALErrorType.Initialization, null, 'this guy');
  };
  ...
  var script = {
    ...
    mounted: function mounted() {
      var self = this;
      var ual = new ualPlainjsRenderer.UALJs(self.userCallback, [exampleNet], 'UAL Test', [// new Scatter([exampleNet], { appName: 'UAL Example' }),
      new ualLedger.Ledger([exampleNet]), new MockAuthenticator([exampleNet])], {
  ...
  var __vue_staticRenderFns__ = [];
    ...
    var ualTrigger = normalizeComponent_1(
